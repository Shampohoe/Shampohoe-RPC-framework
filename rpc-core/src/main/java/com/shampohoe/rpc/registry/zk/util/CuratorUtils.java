package com.shampohoe.rpc.registry.zk.util;

import com.shampohoe.rpc.enums.RpcConfigEnum;
import com.shampohoe.rpc.util.PropertiesFileUtil;
...
public class CuratorUtils {
	...
	private static final String DEFAULT_ZOOKEEPER_ADDRESS = "192.168.159.130";
	...
	public static List<String> getChildrenNodes(CuratorFramework zkClient, String rpcServiceName) {
		...
		try {
			...
			log.error("获取节点下的孩子节点 [{}] 失败", servicePath);
		}
		return result;
	}
	...
	private static void registerWatcher(String rpcServiceName, CuratorFramework zkClient) throws Exception {
		...
		pathChildrenCache.getListenable().addListener(new PathChildrenCacheListener() {
			...
			public void childEvent(CuratorFramework curatorFramework, PathChildrenCacheEvent pathChildrenCacheEvent) throws Exception {
				...
				log.info("服务地址列表:{}", SERVICE_ADDRESS_MAP.get(rpcServiceName));
			}
		});
